...
public class UserServiceImpl implements UserService {
	...
	@Autowired
	private Destination smsSuccessDestination;

	@Value("${template_code2}")
	private String template_code2;
	...
	public void add(final TbUser user) {
		...
		/*jmsTemplate.send(smsSuccessDestination, new MessageCreator() {

			@Override
			public Message createMessage(Session session) throws JMSException {
				MapMessage message = session.createMapMessage();
				message.setString("mobile", user.getPhone());//手机号
				message.setString("templateCode", template_code2);//验证码
	...
	public void createSmsCode(final String phone) {
		...
		jmsTemplate.send(smsDestination, new MessageCreator() {
			...
			public Message createMessage(Session session) throws JMSException {
				...
				message.setString("templateCode", template_code);//验证码
				message.setString("sign_name", sign_name);//签名
				Map map=new HashMap();
